...
class PdfHelper_safkobala_shadharonproof {
  static generate(
      Files14 filesss,
            ...
            children: [
              pw.Expanded(
                  child: pw.Container(
                    margin: const pw.EdgeInsets.symmetric(vertical: 4),
                    alignment: pw.Alignment.center,
                    child: pw.Text("‡gvqvRx- ${filesss.tofshilMouaji14} ",
                        textAlign: pw.TextAlign.center,
                        style: pw.TextStyle(
                          fontSize: 14,
                          font: ttfbold,
    ...
    khomotapraptoatorny[i]['Birth Certificate Number'].isNotEmpty
                        ?pw.Row(
                      children: [
                        pw.Expanded(
                            child: pw.Text(
                        ...
                        pw.Expanded(
                            child: pw.Text(
                            khomotapraptoatorny[i]['Birth Certificate Number'],
                              style: pw.TextStyle(
                                  fontSize: 14,
                                  font: ttfbold,
                                  color: PdfColors.black),
                    ...
                    pw.SizedBox(height: 2),
    khomotapraptoatorny[i]['National ID Number'].isNotEmpty
                        ?pw.Row(
                      children: [
                        pw.Expanded(
                            child: pw.Text(
    ...
    widgets.add(
      pw.Container(
        margin: const pw.EdgeInsets.only(left: 130),
        child: pw.Column(children: [pw.RichText(
          text: pw.TextSpan(
