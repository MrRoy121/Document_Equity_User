...
class PdfHelper_bainabatilnama_shadharonproof {
 static generate(
      Files8 filesss,
                ...
                pw.Container(
                  child: pw.Column(
                    children: [
                      ...
                      pw.Container(
                          width: 90, height: 0.5, color: PdfColors.black)
                    ],
                  ),
                ),
              ],
            ...
            pw.Expanded(
              child: pw.Column(
                children: [
                  ...
                  sss.birthcertificatenumber.isNotEmpty
                      ?pw.Row(
                    children: [
                      pw.Expanded(
                          child: pw.Text(
            ...
            children: [
              pw.Container(
                  child: pw.Column(
                    ...
                    sss.presentaddress.isNotEmpty
                        ? pw.Container(
                            width: 110, height: 0.5, color: PdfColors.black)
                        : pw.Container(
                            width: 55, height: 0.5, color: PdfColors.black),
                    pw.SizedBox(height: 2),
                    pw.Row(
    ...
    widgets.add(pw.Container(
      ...
      child: pw.Column(
        ...
        children: [pw.Container(child: pw.Column(
          crossAxisAlignment: pw.CrossAxisAlignment.center,
          ...
          pw.Paragraph(
              text:
              "     †Rjv-${filesss.tofshildistrict1}, _vbv-${filesss.tofshilThana2}, Dc‡Rjv-${filesss.tofshilupozila3}, †gŠRv-${filesss.tofshilmouja4}, †R, Gj bs-Gm,G-${filesss.tofshiljlnoSA5}, hvnvi we.Gm-${filesss.tofshiljaharBs6}, Gm,G LwZqvb b¤^i${filesss.tofshilSAkhotianNo7}, bvgRvix LwZqvb bs- ${filesss.tofshilNamzariKhotianNo8}, bvgRvix LwZqvb bs- ${filesss.tofshiljaharBSDP9}, hvnvi we.Gm-wW,wc${filesss.tofshilAdaagNo10}, hvnvi we.Gm- ${filesss.tofshiljaharBs12} bs `v‡M †gvqvwR ${filesss.tofshilMouaji13} mvBj iKg f~wg|\n     hvnvi †PŠnvÏv: DË‡i-${filesss.tofshilchouhaddauttor}, c~‡e©-${filesss.tofshilchouhaddadokshin}, c~‡e©-${filesss.tofshilchouhaddapurba}, cwð‡g-${filesss.tofshilchouhaddaposchim}| Bnv‡Z Dc‡iv³ LwZqvb I `v‡M Ges AÎ PZztmxgvi Aš—M©Z †gvqvwR ${filesss.tofshilMouaji13}mvBj iKg f~wgi evqbv evwZjK…Z e‡U|",
              style: pw.TextStyle(
                  fontSize: 14,
                  font: ttfbold,
                  lineSpacing: 5,
        ...
        child: pw.Row(
          ...
          children: [
            pw.Text(
              ...
              style:
                  pw.TextStyle(fontSize: 12, font: ttfbold, color: PdfColors.black),
            ),
          ],
        ),
      ),
