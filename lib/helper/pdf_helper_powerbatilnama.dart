...
class PdfHelper_powerbatilnama_shadharonproof {
  static generate(
      Files17 filesss,
            ...
            child: pw.Column(
              ...
              children: [
                pw.Container(
                  child: pw.Column(
                    children: [
                      pw.Text("cvIqvi Ae A¨vUwb© evwZj bvgv",textAlign: pw.TextAlign.center,
                          style: pw.TextStyle(
                              fontSize: 13,
                              font: ttfbold,
    ...
    String des1 =
        "Am¨ f~wgi cvIqvi Ae A®vUb©x evwZj bvgv cŒ wg`s, †Rjv- ${filesss.tofshildistrict1}, _vbv -  ${filesss.tofshilThana2} I  ${filesss.bhumioffice} m`‡ii GjvKvaxb,  ${filesss.descriptionone}";
    widgets.add(
      pw.Container(
        margin: const pw.EdgeInsets.only(left: 110),
        child: pw.Paragraph(
    ...
    widgets.add(pw.Container(
      ...
      child: pw.Column(
        ...
        children: [pw.Container(child: pw.Column(
          ...
          pw.Paragraph(
              text:
              "     †Rjv-${filesss.tofshildistrict1}, _vbv-${filesss.tofshilThana2}, Dc‡Rjv-${filesss.tofshilupozila3}, †gŠRv-${filesss.tofshilmouja4}, †R, Gj bs-Gm,G-${filesss.tofshiljlnoSA5}, hvnvi we.Gm-${filesss.tofshiljaharBs6}, ${filesss.tofshilbiboron}| \n       ${filesss.tofshilmotMouaji}",
              style: pw.TextStyle(
                  fontSize: 14,
                  font: ttfbold,
                  lineSpacing: 5,
    ...
    for (int i = 0; i < filesss.chowhada.length; i++) {
        ...
        child: pw.Column(
          ...
          pw.Container(
            child: pw.Column(
              ...
              mainAxisAlignment: pw.MainAxisAlignment.center,
              children: [
                pw.Text(filesss.chowhada[i]["Des"],
                    style: pw.TextStyle(
                        fontSize: 14,
                        font: ttfbold,
                        fontWeight: pw.FontWeight.bold,
                ...
                pw.SizedBox(height: 5),
                pw.Paragraph(
                    text:"DË‡it ${filesss.chowhada[i]["Uttor"]}, `wÿ‡Yt ${filesss.chowhada[i]["Dakshin"]}, c~‡e©t ${filesss.chowhada[i]["Purba"]}, cwð‡gt ${filesss.chowhada[i]["Poshim"]}",
                     style: pw.TextStyle(
                        fontSize: 14,
                        font: ttfbold,
                        lineSpacing: 5,
